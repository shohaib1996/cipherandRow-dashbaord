  ...
  monthly: [
    {
      slug: "starter",
      name: "Starter",
      stripe_price_id: "price_1ScoLYKkaK9crZtQXdzwBg4e",
      price_cents: 2900,
      currency: "usd",
      features: [
        "1 bot",
    ...
    },
    {
      slug: "pro",
      name: "Pro",
      stripe_price_id: "price_1ScoLYKkaK9crZtQrBIPtTP5",
      price_cents: 7900,
      currency: "usd",
      features: [
        "Everything in Starter",
        "Remove Powered by Cipher & Row",
        "Higher usage limits",
        "Priority support",
        "Early access",
      ],
  ...
  yearly: [
    {
      slug: "starter-yearly",
      name: "Starter Annual",
      stripe_price_id: "price_1ScoLYKkaK9crZtQxs3xOcgO",
      price_cents: 27800,
      currency: "usd",
      features: [
        "1 bot",
    ...
    },
    {
      slug: "pro-yearly",
      name: "Pro Annual",
      stripe_price_id: "price_1ScoLYKkaK9crZtQKzKgSizX",
      price_cents: 75800,
      currency: "usd",
      features: [
        "Everything in Starter",
...
export default function BillingManager() {
  ...
  const [isUpgrading, setIsUpgrading] = useState<string | null>(null); // store slug of plan being upgraded
